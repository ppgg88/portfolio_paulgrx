...
const template = n =>
    ...
    <a href="https://www.instagram.com/paulgrx/" target="_blank" rel="noopener" class="btn btn-outline-light mt-2"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
